...
export default function SettingsPage() {
  ...
  const loadPreferences = async () => {
    try {
      ...
      if (response.success && response.data) {
        ...
        setDailyGoal(response.data.daily_goal_minutes);
      }
    } catch (error) {
  ...
  if (!preferences) {
    return <div className="text-brown font-bold text-xl">Failed to load preferences</div>;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        {/* General Settings */}
        <div className="bg-white rounded-xl p-8 border-2 border-brown border-opacity-20">
          <h2 className="text-3xl font-bold text-dark mb-6">General Settings</h2>
        ...
        <div className="bg-white rounded-xl p-8 border-2 border-brown border-opacity-20">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start justify-between p-6 bg-cream rounded-xl border-2 border-brown border-opacity-20">
              <div className="flex-1">
                <p className="font-bold text-dark text-lg mb-2">Daily Reminders</p>
                <p className="text-brown font-semibold">
        ...
        <div className="bg-white rounded-xl p-8 border-2 border-brown border-opacity-20">
          ...
          <div className="space-y-4">
            ...
            <Button variant="outline" size="lg" className="w-full justify-start text-red-600 border-red-600 hover:bg-red-50 hover:border-red-600">
              <Trash2 size={20} />
