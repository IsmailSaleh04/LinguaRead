...
export const languagesApi = {
  ...
  async addLanguage(languageCode: string, proficiencyLevel: string): Promise<ApiResponse<TargetLanguage>> {
    return apiCall<TargetLanguage>('/api/user/languages', {
      method: 'POST',
  ...
  async updateLanguage(languageCode: string, proficiencyLevel: string): Promise<ApiResponse<TargetLanguage>> {
